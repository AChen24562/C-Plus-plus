...
int main( ) {
    ...
    cout << "Remove 10 from the array.\n";
    removeElement(numbers, numElements, 10);
    output(numbers, numElements);
    ...
    cout << "Remove 11 from the array.\n";
    removeElement(numbers, numElements, 11);
    output(numbers, numElements);
    return 0;
}
...
void removeElement(int n[], int& sizeofn, int number) {
    ...
    if (index < 0)
    {
        cout << "Invalid input value.  Index can not be found.\n";
        return;
    }
    sizeofn--;
